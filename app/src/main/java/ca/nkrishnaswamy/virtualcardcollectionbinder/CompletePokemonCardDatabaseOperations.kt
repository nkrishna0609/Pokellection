...
class CompletePokemonCardDatabaseOperations(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object{
        const val DATABASE_NAME = "CompletePokemonCard.db"
    ...
    override fun onCreate(db: SQLiteDatabase) {
        db.execSQL("CREATE TABLE $TABLE_NAME(ID INTEGER PRIMARY KEY "+"AUTOINCREMENT,NAME TEXT," +
                ...
                "NUMBER TEXT,RARITY TEXT,SERIES TEXT,SETNAME TEXT,SETCODE TEXT) ")
    }
    ...
    fun insertCard(card: PokemonCard){
        ...
        contentvalues.put(COLUMN_TYPES,card.pokemonTypesSerialized())
        ...
        contentvalues.put(COLUMN_HP,card.getName())
        contentvalues.put(COLUMN_RETREATCOST,card.pokemonRetreatCostSerialized())
